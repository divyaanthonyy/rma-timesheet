...
import { loadEntriesForMonth, loadUserProjects, upsertEntry, updateTimesheetStatus, loadTimesheetStatus, getUserByEmail } from '../../db/queries'
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const [projectsData, entriesData, statusData] = await Promise.all([
